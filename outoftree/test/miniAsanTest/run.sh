...
# GEP tests
# run_test "miniGEPTest/testNULL.c" "Survived NULL GEP access"
# run_test "miniGEPTest/testNullMemcpyDest.c" "Survived NULL destination memcpy"
# run_test "miniGEPTest/testNullMemcpySrc.c" "Survived NULL source memcpy"
# run_test "miniGEPTest/testValidCode.c" "memcpy OK. String is: Valid String"
